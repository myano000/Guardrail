...
GRD008 | Guardrail | Warning | BooleanDisguisedAsEnumAnalyzer, bool偽装enum禁止（TRUE/FALSE, YES/NO等）
GRD009 | Guardrail | Warning | MethodTooLongAnalyzer, メソッドが長すぎる（責務を見直し分割を検討）
